...
func (webCtx *ServerContext) GetInstance(ctx context.Context, token, namespace, instanceName string) (*clv1alpha2.Instance, error) {
...
func (webCtx *ServerContext) validateRequest(firstMsg []byte, localCtx *LocalContext) error {
